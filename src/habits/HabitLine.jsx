...
function HabitLine ({habit, datesHeaders, deleteHabit, updateCheckboxes, checkboxes}) {
  return (
    <tr key={ habit.id} id={ habit.id} className="habit-line">
      ...
      return(  <td key={i} className="checkbox-td">
        ...
        {console.log(day + "_" +  habit.id)
          ...
          onChange={(e) => updateCheckboxes(e)} key={day + "_" + habit.id} id={day + "_" +  habit.id} type="checkbox" className="checkbox-habit"></input>
        </td>)
})}
